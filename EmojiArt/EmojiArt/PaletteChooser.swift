   ...
   //         editing = true
     ...
     //       editing = true
        ...
        AnimatedActionButton(title: "Delete", systemImage: "minus.circle") {
            chosenPaletteIndex = store.removaPalette(at: chosenPaletteIndex)
        }
...
//            PalleteEditor(palette: $store.palettes[chosenPaletteIndex])
//        }
        .popover(item: $paletteToEdit) { palette in
            PalleteEditor(palette: $store.palettes[palette])
        }
